...
const Gallery = ({ lang }) => {
  ...
  const galleryCards = [
    ...
    ...item,
    title: t.galleryItems[idx]?.title || '',
    desc: t.galleryItems[idx]?.desc || '',
    tag: t.galleryItems[idx]?.tag || ''
  }));
    ...
    <section className="gallery section-pad" id="gallery">
      <div className="container">
        <div className="section-header">
          ...
          <h2 className="section-title">{t.galleryTitle}<em>{t.galleryTitleEm}</em></h2>
